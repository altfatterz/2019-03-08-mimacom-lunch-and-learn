        ...
        body(
                ...
                products: [
                        [
                                ...
                                amount            : $(consumer(347.70), producer(regex(aDouble()))),
                        ...
                        [
                                ...
                                amount      : $(consumer(45.70), producer(regex(aDouble()))),
                        ],
                        [
                                id         : $(regex(uuid())),
                                ...
                                amount      : $(consumer(177.70), producer(regex(aDouble()))),
                        ],
                        [
                                id         : $(regex(uuid())),
                                ...
                                type       : $(anyOf('DENTAL')),
                                amount      : $(consumer(96.50), producer(regex(aDouble()))),
                        ],
                        [
                                id         : $(regex(uuid())),
                                ...
                                type       : $(anyOf('PROTECT')),
                                amount      : $(consumer(1.50), producer(regex(aDouble()))),
                        ]
                ]
        )
    }
